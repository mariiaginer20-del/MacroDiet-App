        ...
        if (filteredRecipes.length === 0) {
          return (
            <p style={{ color: '#6b7280', textAlign: 'center', padding: '2rem 0', fontSize: '0.875rem' }}>
              {savedMeals.length === 0 
                ? 'No tienes recetas guardadas. Crea una en "Comidas" y guárdala.'
...
export default MacroDietApp;import React, { useState, useEffect } from 'react';
...
const MacroDietApp = () => {
  ...
  const foodDatabase = [
    ...
    { id: 7, name: 'Cereales sin azúcar', amount: '25g', carbs: 24, fats: 0.5, protein: 2, label: 'H:1' },
    ...
    { id: 11, name: 'Mermelada con azúcar', amount: '50g', carbs: 24, fats: 0, protein: 0.3, label: 'H:1' },
    ...
    { id: 18, name: 'Tortitas arroz/maíz', amount: '25g', carbs: 24, fats: 0.5, protein: 2, label: 'H:1' },
    { id: 19, name: 'Maíz dulce (lata)', amount: '125g', carbs: 24, fats: 1, protein: 3, label: 'H:1' },
      ...
      <div style={{ 
        ...
        <div>
          <div style={{ fontSize: '2.25rem', fontWeight: 'bold', color: '#16a34a', marginBottom: '0.25rem' }}>
            {totals.carbs.toFixed(1)} <span style={{ color: '#4b5563', fontSize: '1.5rem' }}>/ {dailyGoals.carbs}</span>
          </div>
        ...
        <div>
          <div style={{ fontSize: '2.25rem', fontWeight: 'bold', color: '#2563eb', marginBottom: '0.25rem' }}>
            {totals.protein.toFixed(1)} <span style={{ color: '#4b5563', fontSize: '1.5rem' }}>/ {dailyGoals.protein}</span>
          </div>
        ...
        <div>
          <div style={{ fontSize: '2.25rem', fontWeight: 'bold', color: '#d97706', marginBottom: '0.25rem' }}>
            {totals.fats.toFixed(1)} <span style={{ color: '#4b5563', fontSize: '1.5rem' }}>/ {dailyGoals.fats}</span>
          </div>
                      ...
                      <div key={idx} style={{ background: '#f3f4f6', borderRadius: '0.5rem', padding: '0.5rem', border: '1px solid #e5e7eb' }}>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.25rem' }}>
                          <div style={{ fontWeight: '500', color: '#1f2937', fontSize: '0.875rem' }}>
                            {food.name} {qty > 1 && `x${qty}`}
                          </div>
                          <div style={{ fontSize: '0.75rem', color: '#6b7280' }}>{food.amount}</div>
                        </div>
                        <MacroTag carbs={food.carbs * qty} fats={food.fats * qty} protein={food.protein * qty} conversions={conversions} />
                      </div>
                    );
                  })}
                </div>
          ...
          <div key={food.id} style={{
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '0.75rem' }}>
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontWeight: '600', color: '#1f2937', fontSize: '0.875rem', marginBottom: '0.25rem' }}>{food.name}</div>
