...
const MacroDietApp = () => {
  ...
  const foodDatabase = [
    ...
    { id: 6, name: 'Harina Trigo/Espelta', amount: '30g', carbs: 24, fats: 0.0, protein: 0, label: 'H:1' },
    ...
    { id: 53, name: 'Tahini', amount: '15g', carbs: 0, fats: 10, protein: 3, label: 'G:1' },
    ...
    { id: 58, name: 'Yogur+proteínas ará¡ndanos', amount: '200g', carbs: 12, fats: 0, protein: 11, label: '0.5P+0.5H' },
