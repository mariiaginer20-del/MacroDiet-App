...
const MacroDietApp = () => {
  ...
  const foodDatabase = [
    { id: 1, name: 'Patata', amount: '130g', carbs: 24, fats: 0.0 protein: 0.0, label: 'H:1' },
    { id: 2, name: 'Arroz/Pasta/Quinoa', amount: '30g', carbs: 24, fats: 0.0, protein: 0, label: 'H:1' },
    { id: 3, name: 'Boniato', amount: '120g', carbs: 24, fats: 0.0, protein: 0.0, label: 'H:1' },
    { id: 4, name: 'Korn Flakes', amount: '30g', carbs: 24, fats: 0.0, protein: 0.0, label: 'H:1' },
    { id: 5, name: 'Copos/Harina Avena', amount: '30g', carbs: 24, fats: 0, protein: 0, label: 'H:1' },
    { id: 6, name: 'Harina Trigo/Espelta', amount: '30g', carbs: 24, fats: 0.0, protein: 0.0, label: 'H:1' },
    { id: 7, name: 'Cereales sin azúcar', amount: '25g', carbs: 24, fats: 0.0, protein: 0.0, label: 'H:1' },
    { id: 8, name: 'Fruta (pieza)', amount: '1ud', carbs: 24, fats: 0.0, protein: 0.0, label: 'H:1' },
    { id: 9, name: 'Zumo de naranja', amount: '230ml', carbs: 24, fats: 0.0, protein: 0., label: 'H:1' },
    { id: 10, name: 'Dátiles/Fruta desecada', amount: '35g', carbs: 24, fats: 0.0, protein: 0, label: 'H:1' },
    ...
    { id: 14, name: 'Pan', amount: '40g', carbs: 24, fats: 0.0, protein: 0.0, label: 'H:1' },
    { id: 15, name: 'Pan de molde Bimbo', amount: '2 rebanadas', carbs: 24, fats: 0.0, protein: 0, label: 'H:1' },
    { id: 16, name: 'Pan de molde integral', amount: '1.5 rebanadas', carbs: 24, fats: 0.0, protein: 0.0, label: 'H:1' },
    { id: 17, name: 'Tortilla de trigo', amount: '1ud', carbs: 24, fats: 0.0, protein: 0.0, label: 'H:1' },
    { id: 18, name: 'Tortitas arroz/maíz', amount: '25g', carbs: 24, fats: 0.0, protein: 0.0, label: 'H:1' },
    { id: 19, name: 'Maíz dulce (lata)', amount: '125g', carbs: 24, fats: 0.0, protein: 0.0, label: 'H:1' },
    { id: 20, name: 'Palomitas Popitas Zero', amount: '30g', carbs: 24, fats: 0, protein: 0, label: 'H:1' },
    { id: 21, name: 'Papilla de cereales', amount: '2g', carbs: 24, fats: 0.0, protein: 0.0, label: 'H:1' },
    { id: 22, name: 'Azúcar de mesa', amount: '25g', carbs: 24, fats: 0, protein: 0, label: 'H:1' },
    { id: 23, name: 'Pescado blanco', amount: '120g', carbs: 0.0, fats: 0, protein: 22, label: 'P:1' },
    { id: 24, name: 'Molusco', amount: '120g', carbs: 0, fats: 0.0, protein: 22, label: 'P:1' },
    { id: 25, name: 'Marisco', amount: '65g', carbs: 0, fats: 0.0, protein: 22, label: 'P:1' },
    { id: 26, name: 'Atún lata al natural', amount: '100g', carbs: 0, fats: 0, protein: 22, label: 'P:1' },
    { id: 27, name: 'Claras de huevo', amount: '200g', carbs: 0.0, fats: 0.0, protein: 22, label: 'P:1' },
    { id: 28, name: 'Proteína de suero', amount: '30g', carbs: 0.0, fats: 0.0, protein: 22, label: 'P:1' },
